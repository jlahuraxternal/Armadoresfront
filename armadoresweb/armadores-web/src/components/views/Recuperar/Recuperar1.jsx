...
class Recuperar1 extends React.Component {
    constructor() {
        super();
            ...
            <Container style={{
                ...
                <Row style={{height:"100%"}}>
                    ...
                    <Col xs={12} md={9}  style={{ background: '#ffffff', position: 'absolute', top: '0', bottom: '0', right: '0' }}>
                        <Container>
                            <Col xs={12} md={8}  style={{ paddingTop: "10%", paddingLeft: "10%" }}>
                                <Row style={{}}>
                                    <div style={{ color: '#5CBDEB', fontSize: '24px', fontWeight: 'bold' }}>Paso 1 de 3</div>
                                </Row>
                                <Row style={{ marginTop: 90 }}>
                                    <div style={{ color: '#9CA5CA', fontSize: '30px', fontWeight: 'bold' }}>RECUPERACIÓN CONTRASEÑA</div>
                                </Row>
                                <Row style={{ marginTop: 10 }}>
                                    <div style={{ color: '#576774', fontSize: '16px' }}>ingresa el correo electrónico registrado con TASA.</div>
                                </Row>
                                <Row style={{ marginTop: 32 }}>
                                    <div className="form-group" style={{ width: "100%" }}>
                                        <label htmlFor="email" style={{ color: '#020B2B', fontSize: '16px', fontWeight: 'bold' }}>Correo</label>

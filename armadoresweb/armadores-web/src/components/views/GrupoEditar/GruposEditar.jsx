...
class GruposEditar  extends React.Component{
        ...
        for (let index = 0; index < listaP.length; index++) {
            ...
            if (element.ListDetalle !== null){
                ...
                for (let index = 0; index < detalleP.length; index++) {
                    ...
                    if(participanteDet.Estado.startsWith('Agregado')){
                        const ele = {
                ...
                // No hay detalle
                if(element.Estado.startsWith('Agregado')){
                    const ele = {
    ...
    editarParticipanteCab(participante,cab){
        if (cab=="c") {
                                                                        ...
                                                                        <div style={{ width: '100%' }}>
                                                                            <Row style={{ alignItems: 'center', fontSize: '11.7px', color: '#576774' }}>
                                                                                ...
                                                                                <Col xs={2} style={{ textAlign: 'center', padding: '0px 3px 0px 3px' }}>
                                                                                    ...
                                                                                    <Button onClick={() => this.editarParticipanteCab(usuario,(usuario.ListDetalle!=null)?"c":"")}
                                                                                        style={{
                                                                                            padding: '5px',
                                                                                ...
                                                                                <Col xs={1} style={{ padding: '0px 3px 0px 3px' }}>
                                                                                    {usuario.ListDetalle !== null &&
                                                                                        <Accordion.Toggle as={Button}
                                                                                            ...
                                                                                            style={{ textAlign: 'end' }}
                                                                                            onClick={(item) => {
                                                                                                this.abrirDetalle(usuario,index)
                                                                                                //this.abrirDetalle(usuario, usuario.ListDetalle, index);
                                                                                                console.log(item);
                                                                                            }}
                                                                                        >
